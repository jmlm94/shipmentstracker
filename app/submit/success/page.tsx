...
export default function SuccessPage({
  ...
  searchParams: { boxes?: string; code?: string };
}) {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-xl flex-col items-center justify-center px-6 text-center">
      <div className="card w-full p-10">
        ...
        {code && (
          <div className="mx-auto mt-4 inline-block rounded-lg bg-slate-100 px-4 py-2">
        ...
        <p className="mt-3 text-sm text-muted">
          ...
          {boxes === "1" ? "" : "es"}. Keep your shipment code for reference. The
          warehouse team will track each box from here. You can close this page.
        </p>
        <div className="mt-8">
